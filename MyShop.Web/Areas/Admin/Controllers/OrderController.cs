...
namespace MyShop.Web.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderid)
        {
            ...
            {
                OrderHeader = _unitofwork.OrderHeader.FirstOrDefault(u => u.Id == orderid, Includeword: "ApplicationUser"),
        ...
        {
            var orderfromdb = _unitofwork.OrderHeader.FirstOrDefault(u => u.Id == OrderVM.OrderHeader.Id);
